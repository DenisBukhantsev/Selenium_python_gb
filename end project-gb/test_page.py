...
class TestSeacrhLocators:
    ...
    LOCATOR_ABOUT_SIZE = (By.XPATH, '//h1[@class="svelte-z9xc0"]')
...
class OperationsHelper(BasePage):
    ...
    def get_about_page_text(self):
        about_page = self.find_element(TestSeacrhLocators.LOCATOR_ABOUT_SIZE)
        if about_page:
    ...
    def check_about_page_title_font_size(self):
        title = self.find_element(TestSeacrhLocators.LOCATOR_ABOUT_SIZE)
    ...
    def click_about_us(self):
        logging.info("Click about us")
        self.find_element(TestSeacrhLocators.LOCATOR_ABOUT_BTN).click()
